...
void TDiv_Impl(TileDst& dst, TileSrc0& src0, TileSrc1& src1, unsigned validRow, unsigned validCol)
{
...
PTO_INTERNAL void TDIV_IMPL(TileDst& dst, TileSrc0& src0, TileSrc1& src1)
{
    ...
    TDiv_Impl(dst, src0, src1, row, col);
}
} // namespace pto
#endif
