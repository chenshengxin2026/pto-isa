...
private:
    ...
    void visit(const std::vector<ProgramNode>& nodes, int64_t depth, const std::vector<int64_t>& loopStack);
    void emitInst(const ProgramInstNode& inst, int64_t depth, const std::vector<int64_t>& loopStack);
    void emitLoop(const ProgramLoopNode& loopNode, int64_t depth, const std::vector<int64_t>& loopStack);
};
