...
std::vector<std::string> renameLane(const std::vector<std::string>& values, int64_t lane)
{
...
std::vector<ProgramNode> expandBody(const std::vector<ProgramNode>& body, int64_t unroll)
{
...
std::vector<ProgramNode> rewrite(
    const std::vector<ProgramNode>& nodes, const ProgramAnalysis& analysis, ProgramCanonicalizationStats& stats)
{
...
std::vector<ProgramNode> canonicalizeSingleSuperIterationLoops(
    const std::vector<ProgramNode>& program, const ProgramAnalysis::ParamMap& params, const ParamDB& db,
